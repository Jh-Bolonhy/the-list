        ...
        <div class="relative overflow-hidden" :style="{
          ...
          <div class="title-action-slot">
            ...
            >
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 1024 1024">
                <g transform="rotate(-90 512 512)">
                  <path d="M717 884a128 128 0 0 1-128 128H141A128 128 0 0 1 13 884V436a128 128 0 0 1 128-128v64a64 64 0 0 0-64 64v448a64 64 0 0 0 64 64h448a64 64 0 0 0 64-64h64z"/>
                  <path d="M832 769a128 128 0 0 1-128 128H256A128 128 0 0 1 128 769V321a128 128 0 0 1 128-128v64a64 64 0 0 0-64 64v448a64 64 0 0 0 64 64h448a64 64 0 0 0 64-64h64z"/>
                  <path d="M384 128a64 64 0 0 0-64 64v448a64 64 0 0 0 64 64h448a64 64 0 0 0 64-64V192a64 64 0 0 0-64-64H384zm0-64h448a128 128 0 0 1 128 128v448a128 128 0 0 1-128 128H384a128 128 0 0 1-128-128V192A128 128 0 0 1 384 64z"/>
                </g>
              </svg>
            </button>
